...
<?if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die();?>
	...
	<?if($basIsMain):?>
		...
		<div class="container position-relative">
			<div class="bas_my_tab_link">
				<a href="#tabNum6" class="active">Мебель</a>
				<a href="#tabNum7">Фурнитура<span class="d-none d-sm-inline-block">&nbsp;и комплектующие</span></a>
				<a href="#tabNum8">Техника</a>
			</div>
  ...
  'yandex_lat' => 55.786613140993673,
  'yandex_lon' => 37.54828203578198,
  'yandex_scale' => 10,
  'PLACEMARKS' =>
  array (
    0 =>
    array (
      'LON' => 37.439098413076003,
      'LAT' => 55.634766791716999,
      'TEXT' => 'МЦ Румянцево',
      'URL' => '#tab-studio-7547',
    ),
    /*1 =>
    array (
      'LON' => 37.539436110451,
      'LAT' => 55.905454533612001,
      'TEXT' => 'МЦ Империя',
      'URL' => '#tab-studio-7548',
    ),*/
    2 =>
    array (
      'LON' => 37.489166694442758,
      'LAT' => 55.828034155884076,
      'TEXT' => 'МЦ Family Room',
        'URL' => '#tab-studio-7721',
    ),
    /*3 =>
    array (
      'LON' => 37.506948999999999,
      'LAT' => 55.618853999999999,
      'TEXT' => 'ТРЦ Принц Плаза',
        'URL' => '#tab-studio-7929',
    ),*/
    3 =>
    array (
			...
			<div class="container">
				<div class="block d-md-flex justify-content-between align-items-top flex-wrap">
                    ...
                    <?if($basIsMain):?>
                        ...
                        <span class="logo">
							<img src="<?=SITE_TEMPLATE_PATH?>/img/logo.svg" alt="logo" style="width: 165px; margin-top: -13px;">
						</span>
					...
					<div class="block_num3">
                        <a href="javascript:;" class="btn btn-default btn-lg btn-skew" data-toggle="modal" data-target="#basOrderDisModal" style="padding: 0 30px;"><span>ЗАКАЗАТЬ ЗВОНОК</span></a>
					</div>
                    <div class="block_num4">
                        <div class="text-center">
                            <a href="/contacts/" class="map text-left">
                                <b>Как проехать?</b>
                            </a>
                        </div>
		...
		<div class="bottom">
			<div class="container">
                <div class="block">
                    ...
                    <div class="d-flex flex-column soc">
                        <div>
                            Мы в соцсетях
                        </div>
                        <div class="d-flex align-items-center part">
                            <a href="https://vk.com/club163858665" target="_blank" class="mr-4">
								<img src="<?=SITE_TEMPLATE_PATH?>/img/vk-icon.svg" alt="" class="icon-soc">
							</a>
                            <a href="https://instagram.com/evokuhni/" target="_blank">
								<img src="<?=SITE_TEMPLATE_PATH?>/img/insta-icon.svg" alt="" class="icon-soc">
							</a>
                        </div>
                    </div>
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center part">
                            ...
                            <div>
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/master.png" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center part">
                            <div class="mr-2">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/bitmap-copy-3.png" alt="">
                            </div>
                            <div class="mr-2">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/bitmap-copy-4.png" alt="" style="mix-blend-mode: darken">
                            </div>
                            <div>
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/bitmap-copy-5.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
	...
	<div class="modal fade bs-example-modal-sm" id="basViesdDisModal" tabindex="-1" role="dialog" aria-labelledby="basViesdDisModal" aria-hidden="true">
		<div class="modal-dialog modal-sm">
			<div class="modal-content modal-grey-bg">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					<div class="modal-title">Выезд дизайнера в 1 клик</div>
				</div>
				<div class="modal-body">
					<?$APPLICATION->IncludeComponent(
						"bitrix:form", 
				...
				<div class="modal-body">
					<div class="set_zav icon_sprite_one" style="text-align: center">
						<a href="/calculate/" class="link_num1 btn-skew">
                            <span>
                                Заказать дизайн<br>
                                и расчет <i>Бесплатно</i>
                            </span>
						</a>
						<a href="/designer/" class="link_num2 btn-skew">
                            <span>
                                Выезд дизайнера<br>
...
<img src="https://top-fwz1.mail.ru/counter?id=3138124;js=na" style="border:0;position:absolute;left:-9999px;" alt="Top.Mail.Ru" />
</div></noscript>
<!-- //Rating@Mail.ru counter -->
