            ...
            <?foreach($arResult['ITEMS'] as $arItem):?>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="basTovarBlockWrap">
                        ...
                        <?endif?>
                        <div><a data-toggle="tooltip" title="Удалить из избранных" href="#" class="favorites-remove-btn" data-id="<?= $arItem['ID'] ?>"><i class="fas fa-times"></i></a></div>
                        <div class="block bas_block_shadow bas_our_margin basTovarBlock">
                            ...
                            <div class="info">
                                ...
                                <div class="row no-gutters justify-content-between align-items-center">
                                    ...
                                    <?if ($arParams["HIDE_PRICE"] !== 'Y' && $arItem['IBLOCK_ID'] == 4):?>
