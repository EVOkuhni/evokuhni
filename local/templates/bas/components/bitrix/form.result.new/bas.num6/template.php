...
<a id="toq"></a>
<div class="bas_result_new_num6_bg">
	<div class="container">
		<div class="bas_result_new_num6">
						...
						<div class="link">
							<div class="row">
								<div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
									<a href="javascript:;">Указать дополнительную информацию</a>
								</div>
						...
						<div class="row">
							...
							<div class="col-lg-10 col-md-9 col-sm-9 col-xs-12">
								...
								<div class="text-center">
									<a href="javascript:;" class="hide_btn">Скрыть</a>
								</div>
							</div>
						</div>
					</div>
